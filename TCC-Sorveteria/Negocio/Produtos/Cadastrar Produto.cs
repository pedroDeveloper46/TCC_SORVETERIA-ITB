    ...
    public partial class CadastrarProdutos : Modelos.Cadastrar
    {
           ...
           // btnAlterar.Enabled = false;
            try
            {
                ...
                if (ddr.HasRows)
                {
                    ...
                    textBox1.Text = Convert.ToString(ddr["Preco_Produto"]);
                    txtQ.Text = Convert.ToString(ddr["qtdeATUAL_Produto"]);
                    comboBox_Produto.SelectedValue = Convert.ToString(ddr["ID_Fornecedor"]);
                    comboBox1.SelectedValue = Convert.ToString(ddr["ID_Cat"]);
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                pro.Preco_Produto = Convert.ToDecimal((textBox1.Text.Replace("00", " ".Replace(",", ""))));
        ...
        private void mkdPreco_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
