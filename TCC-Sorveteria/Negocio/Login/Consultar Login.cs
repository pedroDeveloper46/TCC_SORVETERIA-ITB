...
namespace TCC_Sorveteria.Negocio.Login
{
    public partial class ConsultarLogin : Modelos.Consultar
    {
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridView2.DataSource = log.ListarAtivos().Tables[0];
        ...
        private void alterarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            cad.button1.Visible = true;
            cad.comboBox1.Enabled = false;
        ...
        private void ativarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (dialog == DialogResult.Yes)
                {
                    ...
                    dataGridView2.DataSource = func.ListarAtivos().Tables[0];
        ...
        private void rdbAtivo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            dataGridView2.DataSource = l.ListarAtivos().Tables[0];
        }

        private void rdbInativo_CheckedChanged(object sender, EventArgs e)
        {
            BLL_SORVETERIA.Login l = new BLL_SORVETERIA.Login();
            dataGridView2.DataSource = l.ListarInativos().Tables[0];
        }
    }
}
